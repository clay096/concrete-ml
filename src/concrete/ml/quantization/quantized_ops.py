...
class QuantizedInstanceNormalization(QuantizedOp):
    """Quantized instance normalization with encrypted input and in-the-clear normalization params."""

    _impl_for_op_named: str = "InstanceNormalization"
